...
local function updateAirPhysics()
...
local function updateGroundPhysics(throttle, steer, speed)
...
local function updateEngine(throttle, steer)
...
local function updateVisualSteering(dt, speed, steer)
...
RunService.Heartbeat:Connect(function(dt)
	...
	if checkIsAirborne() then
		...
		updateGroundPhysics(throttle, steer, speed)
	end

	-- Engine Output
	updateEngine(throttle, steer)

	-- Visual Steering
	updateVisualSteering(dt, speed, steer)
end)
